    ...
    return (
      <div className="py-2 container flex flex-col mt-12">
        <div className="flex flex-col flex-1 items-stretch justify-center h-full text-left border p-8">
          ...
          <Link href={`/blog/${postID}`} className="text-indigo-500 text-xl mt-4">
            Click here to view
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-[calc(100vh-130px)] py-2 container flex flex-col mt-12">
      <form className="flex flex-col flex-1 items-stretch justify-center h-full text-left" onSubmit={handleSubmit}>
        ...
        <button type="submit" className="w-fit-content text-white bg-indigo-400 px-4 py-2 sm:px-6 sm:py-4 mt-6 border-2 rounded shadow-[0.25rem_0.25rem_0px_0px_rgba(0,0,0,1)]">
          Create
        </button>
      </form>
    </div>
